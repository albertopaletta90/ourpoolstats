...
public class MangerMultilingualHome {

	private static MangerMultilingualHome instance;
	...
	private MangerMultilingualHome()
	{
	}

	public static MangerMultilingualHome getInstance()
	{
		if (instance == null)
		{
			instance = new MangerMultilingualHome();
		}
