	...
	<div class="divDashboard">
		...
		<%CoinMarketClient client = new CoinMarketClient();	%>
			<div  class="positionImageInfo">
				<img src="<%=CoinMarketClient.getIcon(coin.getName())%>" width="30"></img>	
			</div>	

		<div class="viewDashboard">
		<div class="divInfo">
			<jsp:include page="../../ourpoolstats/coin/infoCoinMarket.jsp"></jsp:include>
		</div>
		<div class="divGraphic">
			<jsp:include page="../../ourpoolstats/coin/graphich.jsp"></jsp:include>
		</div>
