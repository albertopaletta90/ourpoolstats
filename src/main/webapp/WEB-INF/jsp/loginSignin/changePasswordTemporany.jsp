...
<body>
	...
	<div style="	position: absolute;	top: 23.5%;right: 35%;	border: solid silver 1px;	width: 30%;	height: 50%;">
		...
		<form action="./chagePasswordTemporany" method="post">
		<p class="imputBox">Inserisci la Password Temporanea</p>
		<input class="imputBox" type="text" name="passTemp"></input>
		<p class="imputBox">Inserisci la Nuova Password </p>
		<input class="imputBox" type="password" name="newPass"></input>
		<input type="submit" value="Send"  class="btn btn-outline-secondary" style="position: absolute; top: 210px; left: 40%;">
		</form>
	</div>
	</div>
</body>
