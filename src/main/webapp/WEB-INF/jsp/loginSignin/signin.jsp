...
<body>
	...
	<form action="./signin" method="post">
		<nav class="navbar navbar-light bg-light">
			<h3><%=MultilingualHomeController.getInstance().getSignin() %></h3>
		</nav>	
		...
		<input type="submit" value="<%=MultilingualHomeController.getInstance().getSignin()%>"  class="btn btn-outline-secondary" style="position: absolute; top: 90%; left: 45%">
	</form>
	<form action="./">
		<input type="submit" value="<%=MultilingualHomeController.getInstance().getBack()%>"  class="btn btn-outline-secondary" style="position: absolute; top: 90%; left: 19%">
	</form>
