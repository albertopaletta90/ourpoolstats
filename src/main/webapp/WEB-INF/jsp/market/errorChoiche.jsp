...
<html>
	<head>
		...
		<link href="<c:url value="/resources/css/buttonMarket.css"/>"	rel="stylesheet" type="text/css" />
		<link href="<c:url value="/resources/css/market.css"/>"	rel="stylesheet" type="text/css" />
	...
	<body>
		...
		<div class="divDashboard">
			...
			<div class="viewDashboard">
				<div class ="errorChoiche">
					<nav class="p-3 mb-2 bg-warning text-black">
						<p><%=ManagerMultilingualMarket.getInstance().getErrorChoiche()%></p>
					</nav>
				<form action="./goToMarket"><input type="submit" class="buttonBackChoiche btn btn-outline-secondary" value="<%=MangerMultilingualHome.getInstance().getBack()%>"></form>
				</div>
			</div>
		</div>
	</body>
